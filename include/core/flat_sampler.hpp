...
namespace FlatSampler {
    // FlatMode -> Points
    Eigen::MatrixXd sampleFlat(FlatModel& model, int N, double noise = 0.0, double outlierRatio = 0.0, double outlierStrength = 1.0, double volume = 1.0, bool saltAndPepper = false);
